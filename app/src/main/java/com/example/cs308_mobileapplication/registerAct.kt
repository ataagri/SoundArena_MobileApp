    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        genreSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
                ...
                RetrofitClient.instance.getFavouriteSongsByGenre(getUserToken(this@Sortbygenre).toString(),genreBody).enqueue(object : Callback<JsonObject>{
                    override fun onResponse(
...
class Recommendations : ComponentActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        RetrofitClient.instance.recommendSongs(getUserToken(this@Recommendations).toString()).enqueue(object : Callback<JsonObject>{
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                val jsonResponse = response.body().toString()
